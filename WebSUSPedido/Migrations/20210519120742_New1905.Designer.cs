...
namespace WebSUSPedido.Migrations
{
    ...
    [Migration("20210519120742_New1905")]
                    ...
                    b.OwnsMany("WebSUSPedido.Models.Login.RefreshToken", "RefreshTokens", b1 =>
                        {
                            ...
                            b1.Property<string>("OPE_USUARIOCODIGO_EMPRESA")
                                .IsRequired()
                                .HasColumnType("nvarchar(450)");
                            ...
                            b1.HasIndex("OPE_USUARIOCODIGO_EMPRESA");

                            b1.ToTable("RefreshToken");

                            b1.WithOwner()
                                .HasForeignKey("OPE_USUARIOCODIGO_EMPRESA");
                        });
